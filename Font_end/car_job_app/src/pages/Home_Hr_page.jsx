                    ...
                    <table className="w-full text-center border-collapse">
                         ...
                         <tbody>
                              <tr className="hover:bg-blue-50">
                                   ...
                                   <td className="py-2 border">นายจิรภัทร ชนะสิทธิ์</td>
                                   <td className="py-2 border">13.30 น. - 13.37 น.</td>
                              </tr>
                              <tr className="hover:bg-blue-50">
                                   <td className="py-2 border">2</td>
                                   <td className="py-2 border">นางสาวพัฒนิมา วงศ์สวัสดิ์</td>
                                   <td className="py-2 border">13.37 น. - 13.44 น.</td>
                              </tr>
                              <tr className="hover:bg-blue-50">
                                   <td className="py-2 border">3</td>
                                   <td className="py-2 border">นางสาววรรณล สุเมธิพาธิกุล</td>
                                   <td className="py-2 border">13.44 น. - 13.51 น.</td>
                              </tr>
                         </tbody>
                    </table>
               </div>
